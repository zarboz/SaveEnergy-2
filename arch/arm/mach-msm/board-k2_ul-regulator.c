...
struct regulator_init_data msm8930_saw_regulator_core0_pdata =
	...
	SAW_VREG_INIT(S5, "8038_s5",	       750000, 1300000);
#else
	SAW_VREG_INIT(S5, "8038_s5",	       700000, 1250000);
#endif

struct regulator_init_data msm8930_saw_regulator_core1_pdata =
#ifdef CONFIG_CPU_OVERCLOCK
	SAW_VREG_INIT(S6, "8038_s6",	       750000, 1300000);
#else
	SAW_VREG_INIT(S6, "8038_s6",	       700000, 1250000);
#endif
